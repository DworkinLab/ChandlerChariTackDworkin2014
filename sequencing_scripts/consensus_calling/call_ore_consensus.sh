...
input_bam_file=../bam_alignments/ore.bam
output_file=../consensus_sequences/ore_consensus.fq
output_fasta_file=../consensus_sequences/ore_consensus.fa

#Change the working directory
cd $PBS_O_WORKDIR

#Call the consensus sequence
samtools mpileup -uf $ref_fasta_file $input_bam_file | bcftools view -cg - | vcfutils.pl vcf2fq > $output_file
