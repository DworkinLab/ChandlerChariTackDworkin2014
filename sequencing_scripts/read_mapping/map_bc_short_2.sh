...
fastq_file_1=../reseq_data/bc/BC_short2_1.fastq
fastq_file_2=../reseq_data/bc/BC_short2_2.fastq
sai_file_1=../temp_alignment_data/bc_short_2_1.sai
sai_file_2=../temp_alignment_data/bc_short_2_2.sai
sam_file=../temp_alignment_data/bc_short_2.sam
unsorted_bam_file=../temp_alignment_data/bc_short_2_unsorted.bam
sorted_bam_file_no_ext=../bam_alignments/bc_short_2
sorted_bam_file=../bam_alignments/bc_short_2.bam
