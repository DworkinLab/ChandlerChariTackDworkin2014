...
fastq_file_1=../reseq_data/sam_ore/ORE_1.fastq
fastq_file_2=../reseq_data/sam_ore/ORE_2.fastq
sai_file_1=../temp_alignment_data/ore_1.sai
sai_file_2=../temp_alignment_data/ore_2.sai
sam_file=../temp_alignment_data/ore.sam
unsorted_bam_file=../temp_alignment_data/ore_unsorted.bam
sorted_bam_file_no_ext=../bam_alignments/ore
sorted_bam_file=../bam_alignments/ore.bam
